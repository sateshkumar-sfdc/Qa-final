...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Email_alert_to_notify_the_Inside_Sales_Managers_about_the_Opp_owner_changes</fullName>
        <description>Email alert to notify the Inside Sales Managers about the Opp owner changes.</description>
        <protected>false</protected>
        <recipients>
            <recipient>sumanth.anumukonda@yeti.com</recipient>
            <type>user</type>
        </recipients>
        <senderType>DefaultWorkflowUser</senderType>
        <template>unfiled$public/Opportunity_Owner_Update_email_template</template>
    </alerts>
    <fieldUpdates>
