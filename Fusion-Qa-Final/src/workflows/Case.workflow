...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Case_Reason_Fundraising_Donation</fullName>
        <field>Reason</field>
        <literalValue>Fundraiser/Donation</literalValue>
        <name>Case Reason : Fundraising/Donation</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>Type_Outfitter</fullName>
        <description>Type to outfitter</description>
        <field>Type</field>
        <literalValue>Outfitter</literalValue>
        <name>Type : Outfitter</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <fieldUpdates>
        <fullName>Voided_YETI_Dealer_Agreement</fullName>
        <field>Status</field>
        <literalValue>Closed</literalValue>
        <name>Voided: YETI Dealer Agreement</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
...
8AM - 6PM CST  = 1PM - 10PM GMT = 13 -23 in 24 hr format</description>
    ...
    <rules>
        ...
        <actions>
            <name>Case_Reason_Fundraising_Donation</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        <fullName>Voided%3A YETI Dealer Agreement</fullName>
        <actions>
            <name>Voided_YETI_Dealer_Agreement</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>Case.Subject</field>
            <operation>equals</operation>
            <value>Voided: YETI Dealer Agreement</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
