        ...
        var state = productsearchresult.getState();
         ...
         if (state === "SUCCESS") {
             ...
             if (results == null) {
                 ...
                 var message = "Callout Failure !";
                 this.showToast(cmp, "Error", "Error", message);
                 ...
                 if (returnobj[0].errorMessage != null) {
                     ...
                            
                     var message = returnobj[0].errorMessage;
                     this.showToast(cmp, "Error", "Error", message); 
             ...
             //console.log("No response from server or client is offline.");
              this.showToast(cmp, "Error", "Error", "Incomplete Transaction Try again.");
             // Show offline error
         } else if (state === "ERROR") {
             ...
             if (errors) {
                 ...
                 //console.log("Unknown error");
                 this.showToast(cmp, "Error", "Error", "Unknown error Occurred Try After SomeTime.");
             }
